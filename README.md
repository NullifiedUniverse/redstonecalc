...
digits, and 464,366 blocks in between.
...
- **A browser page** (`docs/preview.html`) — an instrument above a notebook —
  ...
  Merging the 253,517 structure blocks into runs takes it from 464,366 draw
  instances to 243,475; see DESIGN §16. The older Mk I demo is at
...
| Settle | 2,374 game ticks (119 s in game) from the operation lever to the answer |
...
makes the command count affordable: **464,366 blocks become 72,428 commands**,
