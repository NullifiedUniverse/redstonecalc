...
ANCHORS = [
    ...
    (README, r"`go/above` / `go/origin`, because the control wall and the lamps are ([\d,]+) blocks\s+apart", "z"),
    # ---- DESIGN -------------------------------------------------------
    ...
    # §36: the count is the whole rebuttal — the ordering was never the problem
